import {
  ...
  sortHooks,
  useLocation
} from "./chunk-4C2D6YZI.js";
import "./chunk-JSBRDJBE.js";

// src/runtime/client-entry.tsx
import React5, { StrictMode, Suspense } from "react";
...
function findPage(routes, url, path, pageContext, notFound) {
  let rewritten;
  let renderedUrl = url;
...
async function startClient(options = {}, pluginOptions = {}) {
  ...
  app = /* @__PURE__ */ React5.createElement(RouteContext.Provider, { value: "error" in route ? route : { last: route } }, /* @__PURE__ */ React5.createElement(Suspense, null, /* @__PURE__ */ React5.createElement(ErrorBoundary, { FallbackComponent: ErrorComponent }, app)));
  if (import.meta.env.DEV && process.env.RAKKAS_STRICT_MODE === "true") {
    app = /* @__PURE__ */ React5.createElement(StrictMode, null, app);
  }
  const container = document.getElementById("root");
  rakkas.clientRender ? createRoot(container).render(app) : hydrateRoot(container, app);
}
export {
  startClient
};

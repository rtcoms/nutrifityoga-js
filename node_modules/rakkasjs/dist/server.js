import {
  ...
  sortHooks,
  useLocation
} from "./chunk-RMMGVLQO.js";
import {
  __commonJS,
  __toESM
} from "./chunk-JSBRDJBE.js";

// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.10/node_modules/@brillout/json-serializer/dist/cjs/parse.js
var require_parse = __commonJS({
  "../../node_modules/.pnpm/@brillout+json-serializer@0.5.10/node_modules/@brillout/json-serializer/dist/cjs/parse.js"(exports) {
    "use strict";
...
function findPage(routes, url, path, pageContext, notFound2) {
  let rewritten;
  let renderedUrl = url;
...
import React4, { StrictMode, Suspense } from "react";
import {
...
async function renderPageRoute(ctx) {
  ...
  app = /* @__PURE__ */ React4.createElement("div", { id: "root" }, /* @__PURE__ */ React4.createElement(ResponseContext.Provider, { value: updateHeaders }, /* @__PURE__ */ React4.createElement(
    ...
    /* @__PURE__ */ React4.createElement(Suspense, null, app)
  )));
  ...
  const reactStream = await renderToReadableStream(app, {
    ...
    bootstrapModules: renderMode === "server" ? [] : scriptPath ? [assetPrefix + scriptPath] : ["/" + scriptId],
    onError(error) {
      if (!redirected) {
        status = 500;
